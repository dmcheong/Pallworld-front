...
const ReturnPolicy = () => {
  ...
  const policies = [
    ...
    },
    {
      ...
      content:
        "Si vous avez des questions supplémentaires concernant notre politique de retours, n'hésitez pas à nous contacter via notre formulaire de contact, par email à support@palworldeshop.com, ou par chat en direct sur notre site.",
    },
  ];
